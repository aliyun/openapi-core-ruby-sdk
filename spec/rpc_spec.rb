...
#     const rpc = rewire('../lib/rpc');
  ...
  describe 'RPC private methods' do
    it 'firstLetterUpper should ok' do
      expect(firstLetterUpper('helloWorld')).to eq("HelloWorld")
    end

    # it 'formatParams should ok' do
    #   expect(formatParams({'hello': 'world'})).to eql({
    #     Hello: 'world'
    #   })
    # end

    it 'pad2 should ok' do
      expect(pad2(1)).to eq('01')
      expect(pad2(10)).to eq('10')
    end

    it 'timestamp should ok' do
